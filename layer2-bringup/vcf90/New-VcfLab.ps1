<#
.SYNOPSIS
    一鍵 VCF 9.0 bring-up — wrapper: Generate spec -> Validate -> 確認 -> Bring up.
...
Write-Host "=== Step 1/3: 產生 VCF 9.0 bring-up spec ==="
...
if (-not $NonInteractive) {
    Write-Host ""
    Write-Host "Validation 過了. 真的要送 VCF 9.0 bring-up 嗎? (約 1-2 小時, 含 Operations 三件套)" -ForegroundColor Yellow
