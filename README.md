...
| 2 VCF Bring-up | scaffold | **9.0 / 9.1 / 5.2.1 三 template** ready (5.2.1 走 Cloud Builder + Basic Auth);9.0 含 VCF Operations 三件套;timeout workaround 已記錄 | [layer2-bringup/](./layer2-bringup/README.md) |
